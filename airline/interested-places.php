...
<div class="bodyy">
	...
	<div class="flight-opt-cont">
		...
		<div class="flight-opt">
			...
			<div class="fl-a"><h1>Hyderabad FLIGHTS</h1> <p style="font-size:15px;font-family: roboto; margin-left: 5px;margin-top: -15px;">Via :- <a href="result.php<?php echo"?flight=".$hydrabad; ?> ">Bengaluru, Hydrabad, Pune</a></p></div>
		</div><br clear="all">
	</div>
	<div class="flight-opt-cont">
		<div class="flight-opt">
