...
<body>
	...
	<div class="Contacts">
		<div class="adds">
			<img src="bg/me.jpg">
			<p><i class="far fa-address-book"></i><b> Shivam</b><br><i class="fas fa-envelope-open"></i> shivamk438@gmail.com</br><i class="fas fa-mobile-alt"></i> 8949054452</br>Begusarai</br> Bihar-851101</p>
		</div>
	</div>
</h3></div></right>
	<div class="Contacts">
		<div class="adds">
			<img src="bg/Harsha.jpeg">
			<p><i class="far fa-address-book"></i><b> Harsha</b><br><i class="fas fa-envelope-open"></i> harshacph08@gmail.com</br><i class="fas fa-mobile-alt"></i> 9353655809</br>Bangalore</br> Karnataka-560091</p>
		</div>
	</div>
<br clear="all">
	<div class="feed">
		...
		<form action="contact.php" method="POST">
			<input type="text" name="name" required placeholder="Tony Stark">

			<input type="email" name="email" required placeholder="tony@stark.com">

			<input type="text" name="mobile" required placeholder="9696969696">
