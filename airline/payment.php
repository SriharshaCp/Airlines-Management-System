		...
		<div class="cont" >
			...
			<form>
				<div class="add-cont">
            		...
            		<input type="text" id="fname" name="firstname" placeholder="Shivam Choudhary">
            		<label for="email"><i class="fa-lg fa fa-envelope"></i> Email</label>
            		<input type="text" id="email" name="email" placeholder="shivamk438@gmail.com">
            		<label for="adr"><i class="fa-lg fa fa-address-card-o"></i> Address</label>
            		<input type="text" id="adr" name="address" placeholder="69 Baker Street">
            		...
            		<div class="expdate">
              		...
              		<div class="expdate">
                		<tr>
                		<td><input type="text" id="state" name="state" placeholder="BL"></td>
                		<td><input type="text" id="zip" name="zip" placeholder="560057"></td></tr></table>
              		</div>
				</div>
				<div class="card-cont">
            		...
            		<input type="text" id="cname" name="cardname" placeholder="Shivam">
            		...
            		<div class="expdate">
              		...
              		<div class="expdate">
                		<tr>
                		<td><input type="text" id="expyear" name="expyear" placeholder="2069"></td>
                		<td><input type="text" id="cvv" name="cvv" placeholder="369"></td></tr></table>
              		</div>
				</div><br clear="all">
