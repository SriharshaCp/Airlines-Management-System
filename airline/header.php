...
<div class="site-name" id="navbar">
			...
			<h4 class="h4"><img src="icon/call--.png"> 8949054452</h4>
			<h4 class="h41"><img src="icon/mail.png"><a href="mailto:shivamk438@gmail.com">shivamk438@gmail.com</a></h4>
			<div class="menu-list">
				<ul>
					...
					<a class="border-style" href="https://www.linkedin.com/in/thegentleman/#footer" target="blank">Contact Us</a>
