...
<div class="footer contact-us" id="footer">
		...
		<div class="contact1">
			<p>
				<span>Shivam Choudhary</span><br>
				<span>Mobile Number : 8949054452</span><br>
				<span>Email : <a href="Mailto:shivamk438@gmail.com">shivamk438@gmail.com</a></span>
			</p>
			<a id="fa-hand" href="" title="See Link" style="color: red;"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
    		<a id="fa-facebook" href="https://www.facebook.com/thegentl3man" title="Facebook" style="color: #3b5998;"><i class="fab fa-facebook-square" aria-hidden="true"></i></a>
    		<a id="fa-insta" href="https://www.instagram.com/shivamk_choudhary/?hl=en" title="Instagram" style="color: #FE0883;"><i class="fab fa-instagram" aria-hidden="true"></i></a>
    		<a id="fa-tele" href="https://t.me/shivamkchoudhary" title="Telegram" style="color:  #0088cc;"><i class="fab fa-telegram" aria-hidden="true"></i></a>
    		<a id="fa-linkin" href="https://www.linkedin.com/in/thegentleman/" title="Linkedin" style="color: #0e76a8;"><i class="fab fa-linkedin-square" aria-hidden="true"></i></a>
            <a id="fa-whatsapp" href="https://wa.link/11nqte" title="WhatsApp" style="color: #006400;"><i class="fa fa-whatsapp" aria-hidden="true"></i></i></a>
		</div>
