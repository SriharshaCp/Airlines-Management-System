	...
	<div class="login-form">
		...
		<div class="login-form-body">
			<form method="POST" onsubmit="return login_validation()">
				...
				<input type="email" id="mail" name="email" placeholder="Please Enter Your Email"><br>

				<span><label class="emessage" id="pass_message"><span class="spanm">Enter Password : </span></label></span><br>
				<input type="password" id="pass" name="password" placeholder="Please Enter Your Password">
					<span id="s"></span>
...
if (isset($_POST['submit']))
{
	...
	<center><h1 style="color: red; "><?php echo "Please enter a valid email or password......"; ?> </h1></center>
